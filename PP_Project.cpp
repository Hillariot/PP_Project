...
int main()
{
	...
	//center_print("1. ����");
	auto seanses = get_file_info("E:\\C++\\PP_Project\\Data\\Schedule.txt"); 	// ������ ������ � ����� 01.12.2024;Doctor Who;11:00,12:00,16:00
	auto coasts = get_file_info("E:\\C++\\PP_Project\\Data\\Coast.txt");		// ������ ������ � ����� 01.12.2024;Doctor Who;00:00-390rub,15:15-450rub,20:20-500rub
